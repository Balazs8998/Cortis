...
CREATE VIEW data_debug.v_tool_inventory_feature_value AS
...
FROM company.tool_inventory ti
        ...
        JOIN specification.entity_feature_value efv ON efv.entity_id = tm.id and ef.id = efv.entity_feature_id
